...
export class SchemaSync1603691669507 implements MigrationInterface {
    name = 'SchemaSync1603691669507'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_0d92154f2ba671dd0d50709bb7"`);
